...
// const object = {
    ...
    // }
//   };
  setTimeout(object.logMessage, 1000); // After a delay of 1 second, undefined is logged to console.
...
const object = {
  ...
  setTimeout(object.logMessage(), 1000); // or  setTimeout(object.logMessage.bind(object), 1000);